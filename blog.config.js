...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '云木拾羽', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '追风赶月莫停留', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.yunmuyu.top', // 网站地址
